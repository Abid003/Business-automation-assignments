...
$(document).ready(function() {
    ...
    $("#add-icon").click(function() {
        ...
        txt+= " <select class='form-control' aria-label='Default select example' id='gender' name='gender[]'><option value='male'>Male</option><option value='Female'>Female</option> </select>"
        ...
        txt+= "<button type='button' class='btn btn-danger' id='remove-btn'><i class='fa fa-minus'></i></button><br></div>";
        $('#new-form').append(txt);
